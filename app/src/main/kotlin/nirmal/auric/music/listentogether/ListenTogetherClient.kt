...
package nirmal.auric.music.listentogether
...
import nirmal.auric.music.constants.ListenTogetherAutoApprovalKey
import nirmal.auric.music.constants.ListenTogetherIsHostKey
import nirmal.auric.music.constants.ListenTogetherRoomCodeKey
import nirmal.auric.music.constants.ListenTogetherServerUrlKey
import nirmal.auric.music.constants.ListenTogetherSessionTimestampKey
import nirmal.auric.music.constants.ListenTogetherSessionTokenKey
import nirmal.auric.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "nirmal.auric.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "nirmal.auric.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "nirmal.auric.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "nirmal.auric.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(nirmal.auric.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[nirmal.auric.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
