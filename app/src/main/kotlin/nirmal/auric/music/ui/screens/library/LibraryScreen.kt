...
fun LibraryScreen(navController: NavController) {
    ...
    if (showYoutubeImportDialog) {
        ...
        nirmal.auric.music.ui.component.TextFieldDialog(
    ...
    if (showCreatePlaylistDialog) {
        nirmal.auric.music.ui.component.CreatePlaylistDialog(
    ...
    if (showAiPlaylistDialog) {
        nirmal.auric.music.ui.component.CreateAiPlaylistDialog(
