...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "nirmal.auric.music.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "nirmal.auric.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "nirmal.auric.music.widget.playlists.UPDATE_WIDGET"
