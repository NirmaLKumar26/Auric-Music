...
constructor(
    ...
    private val downloadQuality by enumPreference(context, nirmal.auric.music.constants.DownloadQualityKey, nirmal.auric.music.constants.DownloadQuality.YOUTUBE)
        ...
        ResolvingDataSource.Factory(
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    videoId = mediaId,
                    audioQuality = nirmal.auric.music.constants.AudioQuality.OPUS,
