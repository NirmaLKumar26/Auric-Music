...
-keepclassmembers class nirmal.auric.music.utils.sabr.EjsNTransformSolver$SolverWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class nirmal.auric.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class nirmal.auric.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class nirmal.auric.music.utils.cipher.** { *; }
-keep class nirmal.auric.music.utils.sabr.** { *; }
-keep class nirmal.auric.music.utils.potoken.** { *; }
...
## Google Cast Rules
-keep class nirmal.auric.music.cast.** { *; }
...
-keep class nirmal.auric.music.recognition.VibraSignature { *; }
-keepclassmembers class nirmal.auric.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class nirmal.auric.music.listentogether.** { *; }
-keepclassmembers class nirmal.auric.music.listentogether.** {
    *;
}
-keepclassmembers class nirmal.auric.music.listentogether.** {
    *** Companion;
}
-keepclasseswithmembers class nirmal.auric.music.listentogether.** {
    kotlinx.serialization.KSerializer serializer(...);
}
