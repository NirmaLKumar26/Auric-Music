<div align="center">
  <img src="assets/Auric-new.png" alt="Auric Music Logo" width="120"/>
...
<div align="center">
  <table style="margin: 0 auto; border-collapse: collapse;">
    ...
    <tr>
      ...
      <td align="center" style="padding: 15px; border: none;">
        <b>Auric Find (Recognition)</b><br><br>
        <img src="Screenshots/sc_6.png" alt="Auric Find" width="220" style="border-radius: 12px; box-shadow: 0 8px 16px rgba(0,0,0,0.2);"/>
      </td>
    </tr>
  </table>
</div>
...
<details>
<summary><b>Discovery & Auric Find</b></summary>
<br>

- **Auric Find** — Identify songs playing around you using advanced audio recognition.
- **Auric Brain** — An intelligent, on-device engine that analyzes your listening momentum and auto-injects perfectly aligned tracks into your queue. Read more in the [Auric Brain Documentation](ECHO_BRAIN_DOCS.md).
...
Download the latest pre-compiled APK from the [Releases Page](https://github.com/NirmaLKumar26/Auric-Music/releases/latest).
...
4. **Build the Application**
   Auric Music has two build variants: **FOSS** (without Google Play Services / Cast) and **GMS** (with Cast support).
...
Without the support of this incredible open-source community, none of this would be possible. Thank you to everyone who has contributed to Auric Music!

<a href="https://github.com/NirmaLKumar26/Auric-Music/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=NirmaLKumar26/Auric-Music" />
</a>
...
| **[Music Recognizer](https://github.com/aleksey-saenko/MusicRecognizer)** | Audio recognition (Auric Find) |
...
The software is provided "AS IS", without warranty of any kind. The developers of Auric Music do not encourage or condone piracy. Users are solely responsible for ensuring their usage of this app complies with their local copyright laws and the Terms of Service of the platforms they access.

Because we do not host any media files, we cannot process DMCA takedown requests for audio or video content. However, if you represent a copyright holder or have legal concerns regarding the open-source code itself, please contact us via email at: [hello@auricmusic.tndev.in](mailto:hello@auricmusic.tndev.in)
