...
import nirmal.auric.music.utils.PlaybackLogLevel
...
import nirmal.auric.music.utils.cipher.CipherDeobfuscator
import nirmal.auric.music.utils.YTPlayerUtils.MAIN_CLIENT
import nirmal.auric.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import nirmal.auric.music.utils.YTPlayerUtils.validateStatus
import nirmal.auric.music.utils.potoken.PoTokenGenerator
import nirmal.auric.music.utils.potoken.PoTokenResult
import nirmal.auric.music.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: nirmal.auric.music.constants.PlaybackEngine = nirmal.auric.music.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == nirmal.auric.music.constants.PlaybackEngine.POTOKEN || engine == nirmal.auric.music.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == nirmal.auric.music.constants.PlaybackEngine.BRAVEPIPE || engine == nirmal.auric.music.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
