...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "nirmal.auric.music.MainActivityAlias")
        val static = ComponentName(context, "nirmal.auric.music.MainActivityStatic")
        val legacy = ComponentName(context, "nirmal.auric.music.MainActivityLegacy")
