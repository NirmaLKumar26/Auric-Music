...
package nirmal.auric.music.widget
...
import nirmal.auric.music.recognition.MusicRecognitionService
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import nirmal.auric.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "nirmal.auric.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "nirmal.auric.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "nirmal.auric.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "nirmal.auric.music.widget.recognizer.RESET"
    }
}
