...
import nirmal.auric.music.ui.screens.artist.ArtistAlbumsScreen
import nirmal.auric.music.ui.screens.artist.ArtistItemsScreen
import nirmal.auric.music.ui.screens.artist.ArtistScreen
import nirmal.auric.music.ui.screens.artist.ArtistSongsScreen
import nirmal.auric.music.ui.screens.equalizer.EqScreen
import nirmal.auric.music.ui.screens.library.LibraryScreen
import nirmal.auric.music.ui.screens.library.LocalSongScreen
import nirmal.auric.music.ui.screens.playlist.AutoPlaylistScreen
import nirmal.auric.music.ui.screens.playlist.CachePlaylistScreen
import nirmal.auric.music.ui.screens.playlist.LocalPlaylistScreen
import nirmal.auric.music.ui.screens.playlist.OnlinePlaylistScreen
import nirmal.auric.music.ui.screens.playlist.TopPlaylistScreen
import nirmal.auric.music.ui.screens.search.OnlineSearchResult
import nirmal.auric.music.ui.screens.search.SearchScreen
import nirmal.auric.music.ui.screens.settings.AboutScreen
import nirmal.auric.music.ui.screens.settings.AppearanceSettings
import nirmal.auric.music.ui.screens.settings.GlassEffectSettings
import nirmal.auric.music.ui.screens.settings.BackupAndRestore
import nirmal.auric.music.ui.screens.settings.ContentSettings
import nirmal.auric.music.ui.screens.settings.UptimeScreen
import nirmal.auric.music.ui.screens.settings.DarkMode
import nirmal.auric.music.ui.screens.settings.PlayerSettings
import nirmal.auric.music.ui.screens.settings.PrivacySettings
import nirmal.auric.music.ui.screens.settings.RomanizationSettings
import nirmal.auric.music.ui.screens.settings.SettingsScreen
import nirmal.auric.music.ui.screens.settings.AccountSettingsScreen
import nirmal.auric.music.ui.screens.settings.StorageSettings
import nirmal.auric.music.ui.screens.settings.ThemeScreen
import nirmal.auric.music.ui.screens.settings.AiSettings

import nirmal.auric.music.ui.screens.settings.integrations.ListenTogetherSettings
import nirmal.auric.music.ui.screens.recognition.RecognitionScreen
import nirmal.auric.music.ui.screens.recognition.RecognitionHistoryScreen
import nirmal.auric.music.ui.screens.settings.UpdateSettings
import nirmal.auric.music.auricmusic.updater.UpdateScreen
import nirmal.auric.music.utils.rememberEnumPreference
import nirmal.auric.music.utils.rememberPreference
import nirmal.auric.music.auricmusic.changelog.ChangelogScreen
import nirmal.auric.music.auricmusic.commitscreen.CommitScreen
import nirmal.auric.music.ui.screens.equalizer.axion.AxionEqScreen
import nirmal.auric.music.ui.screens.ambient.AmbientModeScreen
...
fun NavGraphBuilder.navigationBuilder(
    ...
    composable("settings/discord") {
        nirmal.auric.music.ui.screens.settings.DiscordSettings(navController, scrollBehavior)
    }

    composable("settings/lastfm") {
        nirmal.auric.music.ui.screens.settings.LastFMSettingsScreen(navController)
    }

    composable("settings/discord/experimental") {
        nirmal.auric.music.ui.screens.settings.DiscordExperimental(navController)
    }
