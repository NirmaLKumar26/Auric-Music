package nirmal.auric.music.auricmusiccanvas
...
@Serializable
data class auricmusicCanvasManifest(
    val items: List<auricmusicCanvasItem> = emptyList()
)

@Serializable
data class auricmusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object auricmusicCanvasProvider {
    ...
    private data class CacheEntry(
        val value: auricmusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): auricmusicCanvasManifest? {
        ...
        return try {
            val manifest: auricmusicCanvasManifest = client.get(BASE_URL).body()
